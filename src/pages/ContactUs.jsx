...
export default function ContactUs() {
  ...
  // Ellaa locations data-vum inga iruku
  const locationsData = [
    {
      area: "Saidapet",
    ...
    <div className="font-sans bg-gray-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center mt-10">
          ...
          <p className="text-lg font-medium tracking-wider">Home <span className="mx-2">/</span> Contact Us</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {/* Screenshot maari 2 columns (md:grid-cols-2) kuduthuruken */}
          ...
          {locationsData.map((loc, index) => (
            <div key={index} className="flex flex-col">
              ...
              <div className="flex flex-col md:flex-row gap-6 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-full">
                ...
                {/* Real map venum na, indha div kulla <iframe> tag use panni Google map embed code-a podalam */}
