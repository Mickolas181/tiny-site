      ...
      <div className="max-w-5xl mx-auto px-6 md:px-4 py-12 md:py-16 text-gray-700 leading-relaxed space-y-12 md:space-y-16">
        ...
        >
          ...
          <div className="space-y-4 text-justify">
            ...
            <p className="font-semibold text-gray-900">We found two categories of children in Autism.</p>
            ...
            <p className="font-semibold text-[#fe5d44]">Now we are proud to say that we have found a way to recover autism with low IQ or severe autism.</p>
