...
export default function SpecialSection() {
  return (
    <section className='flex flex-wrap items-center gap-16 px-24 py-20 bg-white'>
      <div className='flex-1 min-w-[300px] max-w-xl'>
        ...
        <button className='border-2 border-orange-500 text-orange-500 px-8 py-3 rounded-full font-semibold'>Learn More</button>
      </div>
      <div className='flex-1 min-w-[280px] relative flex justify-center'>
