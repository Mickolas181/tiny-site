      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((item, index) => (
            <motion.div
              key={index}
              className={`${item.bg} rounded-2xl p-8 md:p-10 text-center shadow-[0_4px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_40px_rgba(0,0,0,0.10)] hover:-translate-y-2 transition-all duration-300 relative overflow-hidden group cursor-pointer`}
        ...
        <motion.div
          className="mt-20 bg-[#0F3460] rounded-2xl py-12 px-6"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
